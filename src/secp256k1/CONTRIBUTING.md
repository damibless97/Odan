...
The library primarily serves the needs of the Odan Core project but provides additional functionality for the benefit of the wider Odan ecosystem.
...
* **Relevance Arguments:**
    The relevance of the new functionality for the Odan ecosystem should be argued by outlining clear use cases.
...
The Contributor Workflow & Peer Review in libsecp256k1 are similar to Odan Core's workflow and review processes described in its [CONTRIBUTING.md](https://github.com/odan/odan/blob/master/CONTRIBUTING.md).
...
* Use `secp256k1_memcmp_var` instead of `memcmp` (see [#823](https://github.com/odan-core/secp256k1/issues/823)).
