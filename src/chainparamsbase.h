// Copyright (c) 2014-2020 The Odan Core developers
...
/**
 * CBaseChainParams defines the base parameters (shared between odan-cli and odand)
 * of a given instance of the Odan system.
 */
