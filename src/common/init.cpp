// Copyright (c) 2023 The Odan Core developers
...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // odan.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/odan/odan/issues/16220 about ways to
        ...
        // Show an error or warning if there is a odan.conf file in the
