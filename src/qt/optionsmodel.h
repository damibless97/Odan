...
/** Interface from Qt to configuration data structure for Odan client.
...
public:
    ...
    OdanUnit getDisplayUnit() const { return m_display_odan_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSODANontrols() const { return m_enable_psbt_controls; }
...
Q_SIGNALS:
    void displayUnitChanged(OdanUnit unit);
