...
private:
    ...
    //!
    //! The wallet model represents a odan wallet, and offers access to
...
Q_SIGNALS:
    ...
    void incomingTransaction(const QString& date, OdanUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
