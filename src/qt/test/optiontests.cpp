...
{
    // Test regression https://github.com/odan/odan/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/odan-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/odan-core/gui/pull/568.
    // With fListen=false in ~/.config/Odan/Odan-Qt.conf and all else left as default,
    // odan-qt should set both -listen and -listenonion to false and start successfully.
