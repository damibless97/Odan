...
//! Entry point for OdanApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &OdanApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for OdanGUI tests.
void AppTests::guiTests(OdanGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &OdanGUI::consoleShown, this, &AppTests::consoleTests);
