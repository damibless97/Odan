      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->odanAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->odanAtStartup);
    ...
    ui->odanAtStartup->setToolTip(ui->odanAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->odanAtStartup->setText(ui->odanAtStartup->text().arg(PACKAGE_NAME));

    ui->openOdanConfButton->setToolTip(ui->openOdanConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new OdanUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->odanAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSODANontrols);
...
void OptionsDialog::on_openOdanConfButton_clicked()
{
