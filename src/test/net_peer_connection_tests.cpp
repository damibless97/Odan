// Copyright (c) 2023-present The Odan Core developers
...
BOOST_AUTO_TEST_CASE(test_addnode_getaddednodeinfo_and_connection_detection)
{
    ...
    {
        ASSERT_DEBUG_LOG("Added connection to 127.0.0.1:3695 peer=1");
    ...
    for (int i = 0; i < 10; ++i) {
        ASSERT_DEBUG_LOG("Not opening a connection to localhost, already connected to 127.0.0.1:3695");
