...
{
    BOOST_CHECK(TestSplitHost("www.odancore.org", "www.odancore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.odancore.org]", "www.odancore.org", 0));
    BOOST_CHECK(TestSplitHost("www.odancore.org:80", "www.odancore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.odancore.org]:80", "www.odancore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:3695", "127.0.0.1", 3695));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:3695", "127.0.0.1", 3695));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:3695", "::ffff:127.0.0.1", 3695));
    BOOST_CHECK(TestSplitHost("[::]:3695", "::", 3695));
    BOOST_CHECK(TestSplitHost("::3695", "::3695", 0));
    BOOST_CHECK(TestSplitHost(":3695", "", 3695));
    BOOST_CHECK(TestSplitHost("[]:3695", "", 3695));
    ...
    BOOST_CHECK(TestSplitHost("www.odancore.org:65536", "www.odancore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.odancore.org:0", "www.odancore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.odancore.org:", "www.odancore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:3695", "127.0.0.1:3695"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:3695", "[::]:3695"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
