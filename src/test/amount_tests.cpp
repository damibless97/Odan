// Copyright (c) 2016-2021 The Odan Core developers
...
BOOST_AUTO_TEST_CASE(BinaryOperatorTest)
{
    ...
    BOOST_CHECK(b >= a);
    BOOST_CHECK(b >= b);
    // a should be 0.00000002 ODAN/kvB now
    a += a;
    BOOST_CHECK(a == b);
}
...
BOOST_AUTO_TEST_CASE(ToStringTest)
{
    ...
    BOOST_CHECK_EQUAL(feeRate.ToString(FeeEstimateMode::ODAN_KVB), "0.00000001 ODAN/kvB");
