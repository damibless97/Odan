...
This document provides guidelines for internationalization of the Odan Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `odan_en.ts` remains unchanged.
