Odan-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/odan/files/Odan/odan-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Odan
...
New/changed settings (command-line or odan.conf file)
--------------------------------------------------------
