...
Odan Core version 0.19.1 is now available from:

  <https://odancore.org/bin/odan-core-0.19.1/>
...
From Odan Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Odan Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Odan Core does not yet change appearance when
...
- #17488 fix "odand already running" warnings on macOS (fanquake)
