Odan Core version 0.13.2 is now available from:

  <https://odan.org/bin/odan-core-0.13.2/>
...
- #8908 `4a974b2` Update odan-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow odan-tx to create v2 transactions (btcdrak)
