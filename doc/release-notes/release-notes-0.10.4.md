Odan Core version 0.10.4 is now available from:

  <https://odan.org/bin/odan-core-0.10.4/>
...
- #6953 `43c2789` Split odan-tx into its own package
- #6953 `dfe0d4d` Include odan-tx binary on Debian/Ubuntu
