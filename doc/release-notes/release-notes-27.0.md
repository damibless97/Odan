Odan Core version 27.0 is now available from:

  <https://odancore.org/bin/odan-core-27.0/>
...
- libodanconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libodankernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Odan Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Odan Core would
