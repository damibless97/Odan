Odan Core version 0.9.4 is now available from:

  https://odan.org/bin/0.9.4/
...
this update is incompatible with the Odan system and could lead to consensus
forks.

Odan Core released binaries from https://odan.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~odan/+archive/ubuntu/odan
- A third-party or self-compiled Odan Core

upgrade to Odan Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
