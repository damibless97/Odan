Odan Core version 0.9.2.1 is now available from:

  https://odan.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ODAN to 0.01 ODAN
...
- Fix "Start odan on system login"
