Odan version 0.5.4 is now available for download at:
http://sourceforge.net/projects/odan/files/Odan/odan-0.5.4/
...
http://gitorious.org/odan/odand-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Odan-Qt notifications under Growl 1.3.
Increase required age of Odan-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOdan properly when installing Odan-Qt over it. (Windows)
